    ...
    <div>
        ...
        >
            ...
            <template #content>
                ...
                <div
                    v-if="($page as any).props.jetstream.flash.token"
...
export default defineComponent({
    name: 'ApiApiTokenManagerPartial',
    components: {
        JetActionMessage,
        JetActionSection,
        JetButton,
    ...
    data() {
        return {
            createApiTokenForm: (this.$inertia as any).form({
                name: '',
                permissions: this.defaultPermissions,
            }),

            updateApiTokenForm: (this.$inertia as any).form({
                permissions: [],
            }),

            deleteApiTokenForm: (this.$inertia as any).form(),

            displayingToken: false,
            managingPermissionsFor: null as any,
            apiTokenBeingDeleted: null as any,
        };
    },

    methods: {
        createApiToken() {
            this.createApiTokenForm.post(window.route('api-tokens.store'), {
                preserveScroll: true,
                onSuccess: () => {
        ...
        updateApiToken() {
            this.updateApiTokenForm.put(
                window.route('api-tokens.update', this.managingPermissionsFor),
                {
                    preserveScroll: true,
                    preserveState: true,
                    onSuccess: () => {
        ...
        deleteApiToken() {
            this.deleteApiTokenForm.delete(
                window.route('api-tokens.destroy', this.apiTokenBeingDeleted),
                {
                    preserveScroll: true,
                    preserveState: true,
                    onSuccess: () => {
