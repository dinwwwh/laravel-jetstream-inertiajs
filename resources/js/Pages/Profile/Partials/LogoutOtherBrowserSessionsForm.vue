...
export default defineComponent({
    name: 'ProfileLogoutOtherBrowserSessionsFormPartial',
    components: {
        JetActionMessage,
        JetActionSection,
        JetButton,
    ...
    methods: {
        confirmLogout() {
            ...
            setTimeout(() => (this.$refs as any).password.focus(), 250);
        },

        logoutOtherBrowserSessions() {
            this.form.delete(window.route('other-browser-sessions.destroy'), {
                preserveScroll: true,
                onSuccess: () => this.closeModal(),
                onError: () => (this.$refs as any).password.focus(),
